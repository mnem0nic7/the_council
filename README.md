...
- Legacy mission promotion handles missing workflow snapshots stored as either SQL `NULL` or JSON `null`, and normalizes snapshot timestamps to ISO strings before writing JSON columns.
